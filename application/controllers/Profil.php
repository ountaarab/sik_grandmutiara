...
class Profil extends CI_Controller {
    ...
    public function get_data()
    {
        ...
        $this->template->back_end('back_end/v_edit_profil', $data);
    }
    ...
    public function update_profil(){
        ...
        if ($tersedia != NULL) {
            if ($tersedia->id_warga == $id_warga) {
                ...
                $this->session->set_flashdata('msg', '<script> swal("Update Failed!", "Maaf No Rumah sudah Terisi ", "warning"); </script>'); 
                
                redirect('Profil/get_data');
            ...
            if ($_FILES['userfile']['name'] != NULL) {
                ...
                if ($this->upload->do_upload()) {
                    ...
                    $this->session->set_flashdata('msg', '<script> swal("Update Failed!", "Gambar Bermasalah !! ", "error"); </script>'); 
