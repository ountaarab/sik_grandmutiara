                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <br>
                            <p style="text-align:right"><a href="<?php echo base_url() ?>Warga/form_add"><button class="btn btn-success waves-effect waves-light"><i class="fa fa-plus m-l-5"></i> Warga</button></a></p>
                                                        ...
                                                        <div class="btn-group m-r-10">
                                                            ...
                                                            <ul role="menu" class="dropdown-menu">
                                                                ...
                                                                <li><a  
                                                                    ...
                                                                    .then((willDelete) => {
                                                                      if (willDelete) {    
                                                                        window.location = "<?= base_url() ?>Warga/delete/<?= $_warga->id_warga; ?>";
                                                                      } else {
                                        ...
                                        <div class="col-md-8 col-sm-12">
                                            <table class="table table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="<?= base_url() ?>Warga/keluarga/<?= $_warga->id_warga ?>"><i class="fa fa-users m-r-5"></i>Keluarga
                                                            </a>
                                                        </td>
                                                        <th>
                                                        </th>
