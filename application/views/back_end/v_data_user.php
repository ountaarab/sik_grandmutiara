                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Tambah Pengguna</h4> </div>
                                    ...
                                    <form method="post" action="<?php echo base_url() ?>User/add">
                                        <div class="form-group">
                                            ...
                                            <?php 
                                                ...
                                                <option value="<?= $row->id_warga ?>"><?= $row->nama_lengkap ?> (<?= $row->nama_blok ?>-NO. <?= $row->no_rumah ?>)</option>        
                                                <?php
                                                }
                                            ?>
                                            </select>   
                ...
                <div id="ModalEdit-<?= $_row->id_user; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h4 class="modal-title" id="myModalLabel">Edit Pengurus</h4> </div>
                            <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
