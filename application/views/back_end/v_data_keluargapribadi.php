                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <br>
                            <p style="text-align:right"><a href="<?php echo base_url() ?>Keluarga/form_add/<?= $id_warga ?>"><button class="btn btn-success waves-effect waves-light"><i class="fa fa-plus m-l-5"></i> Keluarga</button></a></p>
