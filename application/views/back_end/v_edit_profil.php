    ...
    <div class="col-md-12">
        ...
        <div class="white-box">
            ...
            <div class="row">
                ...
                <form enctype="multipart/form-data" id="form-ajax" action="<?php echo base_url() ?>Profil/update_profil" method="post" class="form-horizontal row-fluid" autocomplete="off">
