                    ...
                    <div class="col-md-12">
                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                    ...
                                    <form enctype="multipart/form-data" action="<?php echo base_url() ?>Profil/update_profil" method="post" class="form-horizontal row-fluid">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    ...
                                                                    <select class="form-control" name="status_menempati">
                                                                        ...
                                                                        <option value="HAK MILIK" <?php if($status_menempati == 'HAK MILIK'){echo" selected";} ?> >HAK MILIK</option>

                                                                        <option value="KONTRAK" <?php if($status_menempati == 'KONTRAK'){echo" selected";} ?> >KONTRAK</option>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    ...
                                                                    foreach ($data_blok->result() as $row) : ?>
                                                                        ...
                                                                        <option value="<?= $row->id_blok ?>" <?php if($id_blok == $row->id_blok){echo" selected";} ?>><?= $row->nama_blok ?></option>                
