                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="row">
                                    <form enctype="multipart/form-data" action="<?php echo base_url() ?>Keluarga/add_keluarga" method="post" class="form-horizontal row-fluid">
                                                    ...
                                                    <table class="table table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>NIK</td>
                                                                <th>
                                                                    <input type="text" value="<?php echo isset($_SESSION['nik']) ? $_SESSION['nik'] : '' ?>" id="nik" required name="nik" placeholder="NIK..." class="form-control">
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <td>Tempat Lahir</td>
